...
async function main() {
  ...
  // Show notification types breakdown for NULL conversationId
  ...
  // Show sample notifications with NULL conversationId
  ...
  // Show sample notifications with NULL agentId but WITH conversationId
